//! Substrate Permissioning Sample runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substrate-permissioning"),
	impl_name: create_runtime_str!("substrate-permissioning"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		AccountSet: accountset::{Module, Config<T>, Call, Storage, Event<T>},
	}
);
